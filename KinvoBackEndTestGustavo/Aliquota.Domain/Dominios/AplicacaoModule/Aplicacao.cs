...
namespace Aliquota.Domain.Dominios.AplicacaoModule
{
    public class Aplicacao : EntidadeBase
    {
        ...
        public void Resgatar(Aplicacao aplicacao, double lucro, DateTime dataResgate)
        {
            ...
            aplicacao.Valor += lucro - taxaSobreLucro;
        }
    }
}
