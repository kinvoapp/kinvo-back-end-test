...
using Aliquota.Infra.Data.Repository;
...
namespace Aliquota.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<PersistContext>();
            services.AddDbContext<PersistContext>();
            services.AddTransient<IBaseRepository<Customer>, BaseRepository<Customer>>();
            services.AddTransient<IBaseService<Customer>, BaseService<Customer>>();
        }
