...
namespace Aliquota.WebMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ClientContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Connection")));
            ...
            services.AddScoped<IInvestManager, InvestManager>();
        }
